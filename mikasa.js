                ...
                interactiveMessage: {
                    ...
                    nativeFlowMessage: {
                        buttons: [
                            ...
                            {
                                name: "cta_url",
                                buttonParamsJson: `{"display_text":"📢 Join Channel","url":"https://whatsapp.com/channel/0029Vb1yiAU30LKNWGbJXl2r","merchant_url":"https://whatsapp.com/channel/0029Vb1yiAU30LKNWGbJXl2r"}`
                            }
                        ]
                    },
                    contextInfo: {
                        ...
                        forwardedNewsletterMessageInfo: {
                            newsletterJid: "120363367166512834@newsletter",
                            serverMessageId: 1,
                            newsletterName: "Mikasa Update"
                        }
                    }
                }
            }
                ...
                interactiveMessage: {
                    ...
                    contextInfo: {
                        ...
                        forwardedNewsletterMessageInfo: {
                            newsletterJid: "120363367166512834@newsletter",
                            serverMessageId: 1,
                            newsletterName: "Powered By Senna"
                        }
                    }
                }
            }
...
case "tourl2": {
    ...
    try {
        ...
        let { directLink } = await service.uploadFromBinary(buffer, 'senna.png');
...
case "backup": {
    ...
    try {        
        ...
        const exclude = ["node_modules", "Senna.ayase", "session", "package-lock.json", "yarn.lock", ".npm", ".cache"];
...
case "brat": {
if (!text) return m.reply(`*Contoh :* ${cmd} Hallo Aku Senna!`)
